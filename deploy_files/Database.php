    ...
    private $conn;
      public function __construct() {
        ...
        $host = $_SERVER['HTTP_HOST'] ?? '';          if (strpos($host, 'pietech-events.is-best.net') !== false) {
            ...
            $this->host = 'sql205.hstn.me';  // Verified working hostname
            $this->dbName = 'mseet_38774389_events';
            $this->username = 'mseet_38774389';  // Verified working username
        ...
        try {
            ...
            try {
                ...
                if (!$dbExists) {
                    ...
                    $this->conn->exec("CREATE DATABASE IF NOT EXISTS `{$this->dbName}` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci");
