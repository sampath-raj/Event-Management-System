...
define('MAIL_USERNAME', getEnvOrDefault('MAIL_USERNAME', 'youremail@gmail.com'));
define('MAIL_PASSWORD', getEnvOrDefault('MAIL_PASSWORD', 'your-app-password'));
define('MAIL_ENCRYPTION', getEnvOrDefault('MAIL_ENCRYPTION', 'tls'));
define('MAIL_FROM_ADDRESS', getEnvOrDefault('MAIL_FROM_ADDRESS', 'noreply@example.com'));
